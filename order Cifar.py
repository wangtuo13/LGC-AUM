...
cmd_pretrain = [
    'pretrain.py --name Cifar_10 --input_size 3072 --n_cluster 10 --hidden_dim 10 --shuffle --pretrain \
    --pretrain_batchsize 256 --pretrain_epoch 800 --pretrain_lr 0.0001 --noise 0.2 --trans\
    --pretrain_optim Adam --net CNN_VAE3 --channel 3 --wide 224 --num_workers 4',
]

cmd_cluster_test = [
    'two_stage.py --name Cifar_10 --input_size 3072 --n_cluster 10 --hidden_dim 10 \
    --pretrain_batchsize 256 --pretrain_epoch 500 --pretrain_lr 0.0001 --noise 0.2 --trans\
    --pretrain_optim Adam --net CNN_VAE3 --channel 3 --wide 224 --num_workers 4\
    --cluster_batchsize 150 --cluster_epoch 50000 --cluster_lr 0.001 --cluster_optim Adam\
    --manifold_lr 0.001 --change 30 --m 10 --divide 0 --total 10000 --Acc 23.96 --times 0',
]

'''
cmd_cluster_test_new = [
--name
Cifar_10
--input_size
3072
...
cmd_cluster = [
    ...
    --name             Cifar_10_train         --n_cluster        10        --num_workers       5     \
    ...
    --Intra_epoch      200             --Inter_epoch     100         --global_epoch     100     \
    --Intra_lr         0.0003        --Inter_lr         0.0001    --global_lr         0.0001\
    --Intra_Max        201           --Inter_Max        101       --Global_Max        101   ',
]

#cmd = cmd_pretrain
#cmd = cmd_cluster_test
cmd = cmd_cluster
