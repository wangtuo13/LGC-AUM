...
cmd_pretrain = [
    'pretrain.py --name Palm --input_size 256 --n_cluster 100 --hidden_dim 10 --shuffle --pretrain \
    --pretrain_batchsize 256 --pretrain_epoch 500 --pretrain_lr 0.001 --noise 0.2 --trans\
    --pretrain_optim Adam --net CNN_VAE3 --channel 3 --wide 224 --num_workers 4 --plot',
]

cmd_cluster = [
    'two_stage.py --name Palm --input_size 256 --n_cluster 100 --hidden_dim 100\
    --pretrain_batchsize 256 --pretrain_epoch 400 --pretrain_lr 0.0001 --noise 0.2\
    --pretrain_optim Adam --net CNN_VAE2 --channel 1 --wide 16 --num_workers 0\
    --cluster_batchsize 1000 --cluster_epoch 500 --cluster_lr 0.001 --cluster_optim Adam\
    --manifold_lr 0.0001 --change 30 --m 10 --divide 0 --total 2000 --Acc 80.5 --times 0',
]

cmd_cluster = [
    'two_stage.py      --nick_name   Ours                                             \
    --name             Palm         --n_cluster         100        --num_workers       5     \
    --optim            Adam          --net              CNN_VAE3  --channel           3     \
    --wide             224           --m                10        --divide            0.1   \
    --reload           False         --hidden_dim       100        --times               0   \
    --Intra_batchsize  300           --Inter_batchsize  300       --global_batchsize  300   \
