...
cmd_pretrain1 = [
    'pretrain.py --name Mnist_test --input_size 784 --n_cluster 10 --hidden_dim 10 --shuffle --pretrain \
    --pretrain_batchsize 256 --pretrain_epoch 500 --pretrain_lr 0.01 --noise 0 --trans\
    --pretrain_optim SGD --net VAE --channel 1 --wide 28 --num_workers 0 --plot',
]

cmd_pretrain2 = [
    'pretrain.py --name train_mnist --input_size 784 --n_cluster 10 --hidden_dim 10 --shuffle --pretrain \
    --pretrain_batchsize 256 --pretrain_epoch 500 --pretrain_lr 0.001 --noise 0.2 --trans\
    --pretrain_optim Adam --net VAE --channel 1 --wide 28 --num_workers 0 --plot',
]
cmd_cluster1 = [
    'two_stage_DEC.py --name Mnist_test --input_size 784 --n_cluster 10 --hidden_dim 10\
    --pretrain_batchsize 256 --pretrain_epoch 300 --pretrain_lr 0.001 --noise 0.1\
    --pretrain_optim Adam --net VAE --channel 1 --wide 28 --num_workers 0\
    --cluster_batchsize 1000 --cluster_epoch 5000 --cluster_lr 0.001 --cluster_optim Adam\
    --manifold_lr 0.0001 --change 2 --m 10 --divide 0.1 --total 70000 --Acc 71.62 --times 55',
]

cmd_cluster3 = [
    'two_stage.py --name QMnist --input_size 784 --n_cluster 10 --hidden_dim 10\
    --pretrain_batchsize 256 --pretrain_epoch 200 --pretrain_lr 0.0001 --noise 0.2\
    --pretrain_optim Adam --net CNN_VAE2 --channel 1 --wide 28 --num_workers 0\
    --cluster_batchsize 1000 --cluster_epoch 5000 --cluster_lr 0.001 --cluster_optim Adam\
    --manifold_lr 0.0001 --change 2 --m 10 --divide 0.1 --total 120000 --Acc 85.83 --times 120',
]
