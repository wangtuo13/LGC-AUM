...
cmd_pretrain = [
    ...
    --pretrain_batchsize 256 --pretrain_epoch 150 --pretrain_lr 0.0001 --noise 0.2 --trans\
...
cmd_two_stage = [
    ...
    --cluster_batchsize 1000 --cluster_epoch 500 --cluster_lr 0.0001 --cluster_optim Adam\
    --manifold_lr 0.0001 --change 1 --m 10 --divide 0.03 --total 2000 --Acc 75.0',
...
cmd_pretrain = [
    'pretrain.py --name STL_10 --input_size 12288 --n_cluster 10 --hidden_dim 10 --shuffle --pretrain \
    --pretrain_batchsize 256 --pretrain_epoch 500 --pretrain_lr 0.0001 --noise 0.2 --trans\
    --pretrain_optim Adam --net CNN_VAE2 --channel 3 --wide 64 --num_workers 0',
]

cmd_cluster = [
    'two_stage.py      --nick_name   Ours                                             \
    --name             STL_10        --n_cluster        10        --num_workers       5     \
    ...
    --Intra_epoch      200             --Inter_epoch      0         --global_epoch      0     \
