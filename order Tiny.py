...
cmd_pretrain = [
    'pretrain.py --name tiny --input_size 12288 --n_cluster 200 --hidden_dim 50 --shuffle --pretrain \
    --pretrain_batchsize 256 --pretrain_epoch 150 --pretrain_lr 0.0001 --noise 0.2 --trans\
    --pretrain_optim Adam --net CNN_VAE2 --channel 3 --wide 64 --num_workers 0 --plot',
]

cmd_cluster = [
    'two_stage.py --name tiny --input_size 12288 --n_cluster 200 --hidden_dim 50\
    --pretrain_batchsize 256 --pretrain_epoch 150 --pretrain_lr 0.0001 --noise 0.2\
    --pretrain_optim Adam --net CNN_VAE2 --channel 3 --wide 64 --num_workers 0\
    --cluster_batchsize 1000 --cluster_epoch 500 --cluster_lr 0.001 --cluster_optim Adam\
    --manifold_lr 0.00001 --change 30 --m 2 --divide 0.01 --total 100000 --Acc 4.43',
]
