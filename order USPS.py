...
cmd_two_stage = [
    ...
    'two_stage.py --name USPS --input_size 256 --n_cluster 10 --hidden_dim 10 \
    --pretrain_batchsize 256 --pretrain_epoch 200 --pretrain_lr 0.0001 --noise 0.2\
    --pretrain_optim Adam --net CNN_VAE2 --channel 1 --wide 16 --num_workers 0\
    --cluster_batchsize 1000 --cluster_epoch 500 --cluster_lr 0.001 --cluster_optim Adam\
    --manifold_lr 0.0001 --change 30 --m 20 --divide 0.3 --total 9298 --Acc 75.44 --times 0',
]

path = 'python '

cmd_pretrain = [
    'pretrain.py --name USPS --input_size 256 --n_cluster 10 --hidden_dim 10 --shuffle --pretrain \
    --pretrain_batchsize 256 --pretrain_epoch 500 --pretrain_lr 0.0001 --noise 0.2 --trans\
    --pretrain_optim Adam --net CNN_VAE2 --channel 1 --wide 16 --num_workers 0',
]

cmd_cluster_our_useful = [
    'two_stage.py --name USPS --input_size 256 --n_cluster 10 --hidden_dim 10 \
    --pretrain_batchsize 256 --pretrain_epoch 200 --pretrain_lr 0.0001 --noise 0.2\
    --pretrain_optim Adam --net CNN_VAE2 --channel 1 --wide 16 --num_workers 0\
    --cluster_batchsize 1000 --cluster_epoch 500 --cluster_lr 0.001 --cluster_optim Adam\
    --manifold_lr 0.0001 --change 30 --m 10 --divide 0.1 --total 9298 --Acc 75.44 --times 31',
]

cmd_cluster_our_try = [
    'two_stage.py      --nick_name   Ours                                                  \
    --name             USPS         --n_cluster        10        --num_workers       5     \
    ...
    --Intra_lr         0.0002        --Inter_lr         0.0001    --global_lr         0.0001 \
...
#cmd = cmd_pretrain
#cmd = cmd_cluster_our_useful
cmd = cmd_cluster_our_try
