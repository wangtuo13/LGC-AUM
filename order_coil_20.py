...
path = 'python3 /home/ubuntu/workspace/'

cmd_run = [
    'pretrain.py --name Coil_20 --input_size 4096 --n_cluster 20 --hidden_dim 20 --shuffle --pretrain \
    --pretrain_batchsize 256 --pretrain_epoch 500 --pretrain_lr 0.0001 --noise 0.1 --trans\
    --pretrain_optim Adam --net CNN_VAE2 --channel 1 --wide 64 --num_workers 0 --plot',
    ...
    'pretrain.py --name Coil_20 --input_size 4096 --n_cluster 20 --hidden_dim 20 --shuffle --pretrain \
    --pretrain_batchsize 256 --pretrain_epoch 500 --pretrain_lr 0.0001 --noise 0.3 --trans\
    --pretrain_optim Adam --net CNN_VAE2 --channel 1 --wide 64 --num_workers 0 --plot',
...
cmd_cluster = [
    'two_stage.py --name Coil_20 --input_size 4096 --n_cluster 20 --hidden_dim 20\
    --pretrain_batchsize 256 --pretrain_epoch 50 --pretrain_lr 0.0001 --noise 0.3\
    --pretrain_optim Adam --net CNN_VAE2 --channel 1 --wide 64 --num_workers 0\
    --cluster_batchsize 1000 --cluster_epoch 1000 --cluster_lr 0.001 --cluster_optim Adam\
    --manifold_lr 0.0001 --change 2 --m 3 --divide 0.2 --total 1440 --Acc 74.51 --times 0',
]
