...
fig = plot_whole_embedding(data_tsne[0:100], Y[0:100])
plt.savefig('E:\run_file\Successful model/' + Data.name + ' initialize')
plt.close()
...
plt.rcParams['figure.figsize'] = (15, 15)
fig = plot_whole_embedding(data_tsne[0:100], Y[0:100])
plt.savefig('E:\run_file\Successful model/' + Data.name + ' Reconstruction')
plt.close()
...
plt.savefig('E:\run_file\Successful model/' + Data.name + ' final')
plt.close()
